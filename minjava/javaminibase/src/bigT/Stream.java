...
public class Stream implements GlobalConst{
    ...
    public Stream(bigT bigtable, int orderType, java.lang.String rowFilter, java.lang.String columnFilter, java.lang.String valueFilter){
        ...
        //may not need these things because we could do this in bigt
        switch (orderType){
            case 1:
                System.out.println("order Type1");
            case 2:
            ...
            case 5:
                System.out.println("order Type5");
...
//    }
    ...
    public MID getFirstMap() throws InvalidTupleSizeException, IOException, InvalidMapSizeException {
        firstDataPage();
        if(dirpage==null){
            return null;
        }
        ...
        if (datapageMid != null) {
            ...
            if (nextDirPageId.pid != INVALID_PAGE) {
                ...
                if(datapageMid != null) {
                    ...
                    if (recmap.getMapLength() != DataPageInfo.size)
                        return false;
    ...
    private boolean nextDataPage()
        ...
        try {
            rectmap = dirpage.getRecord(datapageMid);
        }
        ...
        if (rectmap.getMapLength() != DataPageInfo.size)
            return false;

        dpinfo = new DataPageInfo(rectmap);
        datapageId.pid = dpinfo.pageId.pid;
    ...
    private boolean mvNext(MID mid)
        ...
        if( nextmid != null ){
            nextmid.pageNo.pid = nextmid.pageNo.pid;
            nextmid.slotNo = nextmid.slotNo;
            return true;
        } else {
